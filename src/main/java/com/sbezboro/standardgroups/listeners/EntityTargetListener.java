...
public class EntityTargetListener extends SubPluginEventListener<VanillaGroups> implements Listener {

	public EntityTargetListener(VanillaPlugin plugin, VanillaGroups subPlugin) {
