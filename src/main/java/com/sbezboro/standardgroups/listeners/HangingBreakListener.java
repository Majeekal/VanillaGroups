...
public class HangingBreakListener extends SubPluginEventListener<VanillaGroups> implements Listener {

	public HangingBreakListener(VanillaPlugin plugin, VanillaGroups subPlugin) {
