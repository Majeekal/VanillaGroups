...
public class PlayerBucketEmptyListener extends SubPluginEventListener<VanillaGroups> implements Listener {
	public PlayerBucketEmptyListener(VanillaPlugin plugin, VanillaGroups subPlugin) {
