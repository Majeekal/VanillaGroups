...
public class PlayerInteractListener extends SubPluginEventListener<VanillaGroups> implements Listener {
	...
	public PlayerInteractListener(VanillaPlugin plugin, VanillaGroups subPlugin) {
