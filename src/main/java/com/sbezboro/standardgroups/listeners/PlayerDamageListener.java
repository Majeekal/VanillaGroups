...
public class PlayerDamageListener extends SubPluginEventListener<VanillaGroups> implements Listener {

	public PlayerDamageListener(VanillaPlugin plugin, VanillaGroups subPlugin) {
