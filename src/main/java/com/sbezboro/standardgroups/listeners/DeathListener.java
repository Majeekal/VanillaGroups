...
public class DeathListener extends SubPluginEventListener<VanillaGroups> implements Listener {

	public DeathListener(VanillaPlugin plugin, VanillaGroups subPlugin) {
