...
public class PlayerBucketFillListener extends SubPluginEventListener<VanillaGroups> implements Listener {
	public PlayerBucketFillListener(VanillaPlugin plugin, VanillaGroups subPlugin) {
