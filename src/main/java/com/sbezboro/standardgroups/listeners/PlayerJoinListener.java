...
public class PlayerJoinListener extends SubPluginEventListener<VanillaGroups> implements Listener {
	
	public PlayerJoinListener(VanillaPlugin plugin, VanillaGroups subPlugin) {
