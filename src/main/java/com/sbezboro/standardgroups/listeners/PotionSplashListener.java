...
public class PotionSplashListener extends SubPluginEventListener<VanillaGroups> implements Listener {

	public PotionSplashListener(VanillaPlugin plugin, VanillaGroups subPlugin) {
